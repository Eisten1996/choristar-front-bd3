...
export class RestApi {
  ...
  private static appendAuthorizationHeader(headers: HttpHeaders): HttpHeaders {
  ...
  public get(
    ...
    options.headers = options.isAuthenticated
      ? RestApi.appendAuthorizationHeader(options.headers)
      : options.headers;
  ...
  public put(
    ...
    options = options || {};
    options.headers = RestApi.appendAuthorizationHeader(options.headers);
